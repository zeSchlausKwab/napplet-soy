...
The public installer, project publication journal, source/build freeze, index/naming integration and complete public publish/remix command remain unfinished. The working signer components do not make `napplet publish` available yet.
