...
| `theme`    | Resolved shell colors; live `theme.changed` notifications                                                                      | Light/Dark/Auto preference; napplets opt in to applying colors; no frame reload. See [appearance](APPEARANCE.md)                                                                                                                             |
