...
const styles = `
.nap-settings-trigger{display:inline-flex;align-items:center;justify-content:center;gap:7px;border:1px solid #d1d3c4;background:transparent;color:inherit;border-radius:7px;padding:8px 10px;font:inherit;cursor:pointer}
...
.nap-settings-dialog{position:fixed;z-index:121;left:50%;top:50%;transform:translate(-50%,-50%);width:min(540px,calc(100vw - 32px));max-height:calc(100dvh - 40px);overflow:auto;background:#f8f6ed;color:#292d23;border:1px solid #d1d3c4;border-radius:16px;box-shadow:0 24px 80px #0005;padding:28px;box-sizing:border-box;font:14px 'DM Sans',system-ui,sans-serif}
.nap-settings-dialog *{box-sizing:border-box}.nap-settings-dialog h2{margin:0 40px 8px 0;font-size:26px;line-height:1.15;letter-spacing:-.6px}.nap-settings-description{font-size:13px;color:#63705c;line-height:1.55;margin:0 0 20px}
...
.nap-settings-field{display:grid;gap:6px;margin:0 0 18px}.nap-settings-field label{font-weight:600}.nap-settings-field small{color:#65725e;line-height:1.4}.nap-settings-field input,.nap-settings-field select,.nap-settings-field textarea{width:100%;min-height:40px;padding:9px 11px;border:1px solid #c8cbbf;border-radius:7px;background:#fffdf5;color:#292d23;font:inherit}.nap-settings-field textarea{min-height:76px;font:12px monospace;resize:vertical}
.nap-settings-fields{border:0;padding:0;margin:0}.nap-settings-nested{padding:12px 14px 0;border:1px solid #d1d3c4;border-radius:8px;margin:0 0 18px}.nap-settings-nested legend{padding:0 5px;font-weight:600}.nap-settings-section{font:11px 'DM Mono',monospace;text-transform:uppercase;letter-spacing:1px;color:#447b65;margin:22px 0 13px}
.nap-settings-actions{position:sticky;bottom:-28px;background:#f8f6ed;display:flex;justify-content:flex-end;align-items:center;gap:9px;border-top:1px solid #d1d3c4;padding:17px 0 0;margin-top:8px}.nap-settings-actions button{padding:9px 13px;border:1px solid #c8cbbf;border-radius:7px;background:transparent;color:inherit;font:inherit;cursor:pointer}.nap-settings-actions .nap-settings-save{background:#303828;color:#fffdf5;border-color:#303828}.nap-settings-reset{margin-right:auto}.nap-settings-error{color:#a43e29;font-size:13px;line-height:1.4}.nap-settings-note{font-size:12px;color:#65725e;line-height:1.5}
.nap-settings-dialog :focus-visible,.nap-settings-trigger:focus-visible{outline:2px solid #397c65;outline-offset:3px}@media(max-width:480px){.nap-settings-dialog{padding:22px}.nap-settings-actions{bottom:-22px;flex-wrap:wrap}.nap-settings-reset{margin-right:0}}
`;
